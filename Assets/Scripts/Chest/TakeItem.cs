...
public class TakeItem : MonoBehaviour
{
    ...
    void Start()
    {
        mainUIObject = UI.Instance.gameObject;
    }
            ...
            switch (collision.gameObject.GetComponent<ItemInfo>().rareType)
                {
                    case Utils.RareTypes.common:
                        mainUIObject.GetComponent<UI>().StartNewMessage($"{uidata.commonColor}Вы подобрали \"{collision.gameObject.GetComponent<ItemInfo>().itemName}\"", $"{uidata.commonColor}{collision.gameObject.GetComponent<ItemInfo>().pickUpMessageDescription}");
                        break;
                    case Utils.RareTypes.rare:
                        mainUIObject.GetComponent<UI>().StartNewMessage($"{uidata.commonColor}Вы подобрали \"{uidata.rareColor}{collision.gameObject.GetComponent<ItemInfo>().itemName}\"", $"{uidata.commonColor}{collision.gameObject.GetComponent<ItemInfo>().pickUpMessageDescription}");
                        break;
                    case Utils.RareTypes.mythic:
                        mainUIObject.GetComponent<UI>().StartNewMessage($"{uidata.commonColor}Вы подобрали \"{uidata.mythicColor}{collision.gameObject.GetComponent<ItemInfo>().itemName}", $"{uidata.commonColor}{collision.gameObject.GetComponent<ItemInfo>().pickUpMessageDescription}");
                        break;
                    case Utils.RareTypes.legendary:
                        mainUIObject.GetComponent<UI>().StartNewMessage($"{uidata.commonColor}Вы подобрали \"{uidata.legendaryColor}{collision.gameObject.GetComponent<ItemInfo>().itemName}", $"{uidata.commonColor}{collision.gameObject.GetComponent<ItemInfo>().pickUpMessageDescription}");
                        break;
                }
