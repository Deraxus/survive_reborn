...
public class Weapon : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("�����");*/
        reloadBarSlider = UIManager.Instance.reloadBarSlider.GetComponent<Slider>();
        startRate = data.rate;
        ...
        patronsText = UIManager.Instance.patrons;
        patronsPanelSprite = UIManager.Instance.patronsPanelSprite;
